...
#     def __init__(self, T=4, embed_dim=64, n_node_features=4, n_edge_features=1, bias=False):
    def __init__(self, T=4, embed_dim=64, n_node_features=4, bias=False):
        super().__init()
...
#             n_edge_features=n_edge_features,
        ...
        self.q_layer = QNetwork(embed_dim=embed_dim, bias=False)
    ...
    def forward(self, state):
        ...
        embeddings = torch.zeros(self.embed_dim).to(device)
